 ...
 * logging calls. This causes no additional object if logging level is not enabled, even if using primitives. Got the
 * idea from Google's fluent logging (https://google.github.io/flogger/). You get a fluent-logger by calling
